...
<img src="site/img/icon.png" width="120" alt="Overflow icon">

# Overflow

**Reaches the menu bar items macOS hides behind the notch.**

[![CI](https://github.com/nicglazkov/overflow/actions/workflows/ci.yml/badge.svg)](https://github.com/nicglazkov/overflow/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![macOS 14+](https://img.shields.io/badge/macOS-14%2B-black?logo=apple)](https://www.apple.com/macos/)
[![Zero permissions](https://img.shields.io/badge/permissions-optional-brightgreen)](#permissions)

<img src="site/img/menu.png" width="330" alt="Overflow's menu showing hidden status items">
...
The item is gone. There is no overflow menu, no indicator, and no way to click it.
...
<div align="center">
<img src="site/img/settings.png" width="420" alt="Overflow settings window">
</div>

## Install

Download the latest `Overflow.zip` from [Releases](https://github.com/nicglazkov/overflow/releases),
unzip, and drag `Overflow.app` to `/Applications`.
...
```sh
git clone https://github.com/nicglazkov/overflow.git
cd overflow
make install
```
...
Overflow's own chevron, so an oversized value deletes the app's only UI:
...
**Overflow works with no permissions at all.** Finding, listing and hiding items need nothing.
...
Overflow never requests Screen Recording. Other menu bar managers need it because they redraw
other apps' status-item images; Overflow draws the owning app's bundle icon instead.
...
- **When the bar is completely full, the fallback surrenders the chevron.** There is no space to
  reveal into, so Overflow gives up its own width for eight seconds and restores it on a timer.
...
make release  # produce Overflow.zip
```
